                ...
                {{-- @foreach ($products as $product)
                    ...
                    <div>
                        @foreach ($product->images as $image)
                            <img src="{{asset('storage/' . $product->images->first()->image_url) }}" alt="Product Image" style="max-width: 150px;">
                        @endforeach
                    </div>
                @endforeach --}}
                @foreach ($products as $product)
                    <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item">
                        ...
                        <div class="block2">
                            <div class="block2-pic hov-img0">
                                ...
                                @else
                                    <img src="{{ asset('assets/images/default-product.jpg') }}" alt="IMG-PRODUCT">
                                @endif
					...
					<div class="block2">
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							...
							<div class="block2-txt-child2 flex-r p-t-3">
								<a href="#" class="btn-addwish-b2 dis-block pos-relative js-addwish-b2">
									<img class="icon-heart1 dis-block trans-04" src="{{ asset('assets/images/icons/icon-heart-01.png') }}" alt="ICON">
									<img class="icon-heart2 dis-block trans-04 ab-t-l" src="{{ asset('assets/images/icons/icon-heart-02.pn') }}g" alt="ICON">
								</a>
							</div>
						</div>
					</div>
