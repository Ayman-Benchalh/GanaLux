...
<body>
    <div class="min-h-screen flex flex-col md:flex-row">
        ...
        <div class="w-full md:w-64 bg-blue-900 text-white p-5 space-y-6 transition-transform duration-300">
            ...
            <nav>
                <a href="{{ route('dashboard') }}" class="block py-2.5 px-4 rounded hover:bg-blue-700 flex items-center gap-2">
                ...
                <a href="{{ route('admin.products') }}" class="block py-2.5 px-4 rounded hover:bg-blue-700 flex items-center gap-2">
